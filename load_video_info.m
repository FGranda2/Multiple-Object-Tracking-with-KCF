function [img_files, pos, target_sz, video_path] = load_video_info(base_path, video)
%LOAD_VIDEO_INFO
...
%   http://www.isr.uc.pt/~henriques/
    ...
    Size = size(ground_truth);
    for i = 1: Size(1,1)
        
        %set initial position and size
        target_sz(i,1:2) = [ground_truth(i,4), ground_truth(i,3)];
        %pos = [ground_truth(1,2), ground_truth(1,1)] + floor(target_sz/2);
        pos(i,1:2) = [ground_truth(i,2), ground_truth(i,1)];
