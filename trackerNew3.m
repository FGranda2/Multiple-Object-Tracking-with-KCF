function [positions, time] = trackerNew3(video_path, img_files, pos, target_sz, ...
	...
	for frame = 1:numel(img_files)
        ...
        for i = 1: Size(1,1)
            ...
            if posNew(i,1) > 0
                ...
                %pos(i,1) = mean([posNew(i,1) pos(i,1)]);
                %pos(i,1) = (match(i,2)*pos(i,1) + match(i,2)*posNew(i,1)) / (match(i,2)+match(i,2));
            ...
            if posNew(i,2) > 0
                ...
                %pos(i,2) = mean([posNew(i,2) pos(i,2)]);
                %pos(i,2) = (match(i,2)*pos(i,2) + match(i,2)*posNew(i,2)) / (match(i,2)+match(i,2));
