function update_visualization_func = show_videoNew3(img_files, video_path, resize_image)
%SHOW_VIDEO
...
%   http://www.isr.uc.pt/~henriques/
	...
	function stop = update_visualization(frame, box1)
        Size = size(box1);
        numBox = Size(1,1);
        for i=1:numBox
	...
	function redraw(frame)
        ...
        for k=1:numBox
            ...
            if isempty(rect_h1{1,k})  %create it for the first time
